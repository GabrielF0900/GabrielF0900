...
| :--- | :--- | :--- | :--- |
| **🎫 Sistema de Gerenciamento de Chamados** | Plataforma completa de gestão de tickets e chamados com autenticação, dashboard e relatórios | NestJS, React, TypeScript, PostgreSQL, Docker | [Acessar →](https://github.com/GabrielF0900/chamado_system) |
| **☁️ API Serverless Ecommerce** | API REST serverless escalável com autenticação, pagamentos e integração com serviços AWS | AWS Lambda, API Gateway, DynamoDB, SQS, Node.js | [Acessar →](https://github.com/GabrielF0900/api-serverless-ecommerce) |
| **📊 Plataforma de Monitoramento em Nuvem** | Dashboard de monitoramento de recursos AWS em tempo real com alertas inteligentes | AWS CloudWatch, EC2, RDS, React.js, TypeScript | [Acessar →](https://github.com/GabrielF0900/cloud-monitoring-platform) |
| **🛡️ CityShield (TCC)** | Solução de segurança para Smart Cities com foco em arquitetura AWS serverless e escalabilidade | AWS Lambda, S3, DynamoDB, Node.js | [Acessar →](https://github.com/GabrielF0900/cityshield) |
